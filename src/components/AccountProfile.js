                  ...
                  <div className="cover-container text-center">
                    ...
                    <div className="profile-detail mt-3">
                      ...
                      <p>
                        ...
                        massa.Morbi nulla dolor, ornare at commodo non, feugiat
                        non nisi.
                      </p>
                    </div>
                  ...
                  <div className="iq-card-body">
                    <ul className="list-inline p-0 mb-0">
                      <li className="d-flex mb-4 align-items-center">
                        ...
                        <div className="iq-card-toolbar ml-auto">
                          <div className="dropdown">
                            ...
                            >
                              <a className="dropdown-item" href="#">
                                <i className="ri-user-unfollow-line mr-2" />
                                Share
                              </a>
                              <a className="dropdown-item" href="#">
              ...
              <div className="iq-card-body">
                <ul className="perfomer-lists m-0 p-0">
                  <li className="d-flex mb-4 align-items-center">
                    ...
                    <div className="iq-card-header-toolbar d-flex align-items-center ml-auto">
                  ...
                  <li className="d-flex mb-4 align-items-center">
                    ...
                    <div className="iq-card-header-toolbar d-flex align-items-cener ml-auto">
                      <span className="text-dark">
                        <b>+$85</b>
                      </span>
                    </div>
